...
const TransactionGraph: React.FC = () => {
    ...
    return (
        <div
            style={{
                backgroundColor: "#1a1a1a", color: "#fff", padding: "1.5rem", borderRadius: "16px", boxShadow: "0px 6px 20px rgba(0, 0, 0, 0.6)"
            }}>
            <Box sx={{ backgroundColor: "#1a1a1a", borderRadius: "16px", padding: "1.5rem", boxShadow: "0px 4px 15px rgba(0, 0, 0, 0.5)" }}>
                <ResponsiveContainer width="100%" height={300}>
                    ...
                    >
                        ...
                        <YAxis stroke="#aaa" />
                        <Tooltip
                            contentStyle={{ backgroundColor: "#222", borderRadius: "10px", borderColor: "#444", color: "#fff" }}
                            itemStyle={{ color: "#ddd" }}
                            cursor={{ stroke: "rgba(255, 255, 255, 0.1)", strokeWidth: 2 }}
                        />
                        <Legend wrapperStyle={{ color: "#fff" }} />
                        <Line type="monotone" dataKey="totalAmount" fill="#add8e6" strokeWidth={3} dot={{ r: 6 }} activeDot={{ r: 8 }} />
            ...
            <FormControl variant="outlined" margin="normal" fullWidth>
                ...
                >
                    <MenuItem value="deposit" sx={{ fontSize: "0.85rem", padding: "6px 12px" }}>Deposit</MenuItem>
                    <MenuItem value="withdraw" sx={{ fontSize: "0.85rem", padding: "6px 12px" }}>Withdraw</MenuItem>
                </Select>
            </FormControl>
        </div>
    );
